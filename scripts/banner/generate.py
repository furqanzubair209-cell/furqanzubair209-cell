...
SOURCE = ROOT / "assets/source/furqan_cutout.png"
ASSETS = ROOT / "assets"
...
ROWS = [
    ("Subject", "Muhammad Furqan"),
    ("Role", "Frontend AI Engineer · Full-Stack Dev"),
    ("Origin", "Lahore, Pakistan"),
    ("Education", "BSCS · Superior University"),
    ("Status", "Building + Learning + Shipping"),
    ("ToolChain", "VS Code · Git · Claude Code"),
    ("Core.Lang", "TypeScript · Python · C++"),
    ("Core.Frontend", "React · Vite · Tailwind · Framer Motion"),
    ("Core.Backend", "Node.js · Express · Prisma"),
    ("Core.AI/ML", "TensorFlow · Scikit-learn · OpenCV"),
    ("Core.Infra", "MySQL · n8n · Docker"),
    ("Grid.Mail", "furqanzubair209@gmail.com"),
    ("Grid.LinkedIn", "/in/muhammad-furqan-228807304"),
    ("Grid.GitHub", "furqanzubair209-cell"),
    ("Grid.Upwork", "Freelance Software Engineer"),
]
...
def portrait_points(theme: str, rng: np.random.Generator) -> np.ndarray:
    ...
    crop = source.crop((5, 5, 355, 385)).resize((300, 340), Image.Resampling.LANCZOS)
...
def render_svg(
    ...
    parts: list[str] = [
        ...
        "<title id=\"title\">Muhammad Furqan's live system profile</title>",
        '<desc id="desc">Animated terminal profile with a dithered portrait and '
        "gear, code, and network silhouettes.</desc>",
        "<defs>",
    ...
    parts.extend(
        [
            ...
            'font-weight="700">@furqanzubair209</text>',
        ]
    )
